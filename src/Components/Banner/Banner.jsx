...
import AOS from "aos";
import BannerImg from "../../assets/winter.jpg";
        ...
        <div className="container">
          <div className="grid grid-cols-2 gap-6 items-center">
            ...
            <div className="flex flex-col justify-center gap-6 sm:pt-0">
              ...
              >
                Enjoy our Winter Sale with discounts of up to 50% on selected
                items. Shop your favorite styles at half the price. Hurry—
